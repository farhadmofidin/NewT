...
body.push(spacer(80));
body.push(p("این پروژه در سه فاز و مجموعاً ۴۵ روز اجرا می‌شود و پس از استقرار، پشتیبانی و توسعهٔ نامحدودِ نیازهای شفاف‌سازی به‌صورت ماهیانه ارائه می‌گردد.", { bold: true, color: NAVY }));
body.push(spacer(40));
body.push(dataTable(
  ["عنوان", "شرح"],
  [
...
body.push(dataTable(
  ["ردیف", "شرح", "مبلغ (تومان)"],
  [
    ["۱", "اجرای فاز اول — ساخت انبار داده (۱۰ روز)", "۶۵٬۰۰۰٬۰۰۰"],
    ["۲", "اجرای فاز دوم — مایگریشن و متناظرسازی (۲۰ روز)", "۱۱۰٬۰۰۰٬۰۰۰"],
    ["۳", "اجرای فاز سوم — پلتفرم BI و داشبوردها (۱۵ روز)", "۹۰٬۰۰۰٬۰۰۰"],
...
body.push(spacer(60));
body.push(p("پرداخت مبلغ هر فاز متناسب با تحویل همان فاز انجام می‌شود؛ مبلغ کل قرارداد اجرا ۲۶۵ میلیون تومان است.", { size: 20, color: GREY }));
body.push(spacer(60));
