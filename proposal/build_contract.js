...
body.push(p("طراحی و اجرای پروژهٔ شفاف‌سازی و یکپارچه‌سازی سیستم اطلاعاتی کارفرما میان سه سامانهٔ عملیات، انبار و حسابداری، مشتمل بر چهار فاز که شرح فعالیت‌ها، خروجی‌ها و نتایج قابل‌تحویلِ هر فاز به‌تفصیل در مادهٔ ۴ این قرارداد آمده است."));
...
body.push(spacer(60));
body.push(p("شرح تفصیلی فعالیت‌ها، خروجی‌ها و نتایج قابل‌تحویلِ هر فاز به‌شرح زیر است. تحقق «خروجی‌ها و نتایج قابل‌تحویل» هر فاز، شرط تحویل و تأیید آن فاز موضوع مادهٔ ۶ است:"));

const ptitle = (txt) => p(txt, { bold: true, color: NAVY, before: 120, after: 40 });
const plabel = (txt) => p(txt, { bold: true, color: TEAL, size: 20, after: 30 });

// Phase 1
body.push(ptitle("۴-۱) فاز اول — رمزگشایی دیتابیس سه نرم‌افزار (۱۰ روز)"));
body.push(plabel("فعالیت‌ها:"));
body.push(bullet("مهندسی معکوس و رمزگشایی ساختار دیتابیس هر سه نرم‌افزار (عملیات، انبار، حسابداری): جداول، روابط و فیلدها."));
body.push(bullet("شناسایی محل ذخیرهٔ دستور کار، اقلام مصرفی، صورت‌حساب، اسناد مالی و موجودی."));
body.push(bullet("باز کردن داده‌های رمزنگاری‌شده/کدشده و برقراری دسترسی امن و پایدار به داده‌ها."));
body.push(plabel("خروجی‌ها و نتایج قابل‌تحویل:"));
body.push(bullet("نقشهٔ کامل ساختار دیتابیس هر سه نرم‌افزار."));
body.push(bullet("دیکشنری داده (Data Dictionary) شامل تعریف جداول و فیلدهای کلیدی."));
body.push(bullet("روش مستند و امنِ دسترسی به داده‌ها، به‌عنوان پیش‌نیاز فاز دوم."));

// Phase 2
body.push(ptitle("۴-۲) فاز دوم — ساخت انبار داده (۱۰ روز)"));
body.push(plabel("فعالیت‌ها:"));
body.push(bullet("شناسایی و مستندسازی منابع داده در همهٔ شعب."));
body.push(bullet("پیاده‌سازی فرآیند استخراج، تبدیل و بارگذاری داده (ETL) از سه سامانه."));
body.push(bullet("پاک‌سازی، استانداردسازی و یکدست‌سازی داده‌ها (تاریخ، کد کالا، کد شعبه، مشتری)."));
body.push(plabel("خروجی‌ها و نتایج قابل‌تحویل:"));
body.push(bullet("انبار دادهٔ مرکزی و یکپارچه از هر سه سامانه و همهٔ شعب (منبع واحد حقیقت)."));
body.push(bullet("مستندات مدل داده و فرآیند ETL."));
body.push(bullet("فرآیند تکرارپذیرِ بارگذاری و به‌روزرسانی داده."));

// Phase 3
body.push(ptitle("۴-۳) فاز سوم — مایگریشن و متناظرسازی (۲۰ روز)"));
body.push(plabel("فعالیت‌ها:"));
body.push(bullet("تعریف کلید مشترک و قواعد متناظرسازی بین دستور کار، انبار و حسابداری."));
...
body.push(bullet("مایگریشن و تطبیق دادهٔ تاریخی و اعتبارسنجی نتایج با نمونه‌گیری."));
body.push(plabel("خروجی‌ها و نتایج قابل‌تحویل:"));
body.push(bullet("گزارش مغایرت‌گیری خودکار که دقیقاً محل عدم‌تطابق انبار با عملیات و حسابداری را نشان می‌دهد."));
body.push(bullet("دسته‌بندی مغایرت‌ها: قلم کسرنشده، سند مالی مفقود، درآمد بی‌انتساب و مغایرت تنخواه."));
body.push(bullet("دادهٔ تاریخیِ متناظرشده و اعتبارسنجی‌شده."));

// Phase 4
body.push(ptitle("۴-۴) فاز چهارم — پلتفرم BI و داشبوردها (۱۵ روز)"));
body.push(plabel("فعالیت‌ها:"));
body.push(bullet("راه‌اندازی پلتفرم هوش تجاری (BI) و اتصال آن به انبار داده."));
body.push(bullet("طراحی و پیاده‌سازی داشبوردها با قابلیت drill-down و فیلترگذاری آزاد."));
body.push(bullet("آموزش کاربران و تحویل مستندات بهره‌برداری."));
body.push(plabel("خروجی‌ها و نتایج قابل‌تحویل:"));
body.push(bullet("داشبورد عملیاتی: حجم عملیات و عملکرد شعب."));
body.push(bullet("داشبورد انبار: موجودی، گردش کالا و مغایرت موجودی."));
body.push(bullet("داشبورد مالی: درآمد، بهای تمام‌شده و سود/زیان."));
body.push(bullet("داشبورد مغایرت‌گیری: پایش لحظه‌ای هم‌خوانی سه سامانه."));
body.push(bullet("قابلیت drill-down تا سطح تراکنش، به‌همراه مستندات و آموزش کاربران."));
...
body.push(bullet("اجرای کامل موضوع قرارداد مطابق فازها، خروجی‌ها و نتایج قابل‌تحویلِ مندرج در مادهٔ ۴ این قرارداد."));
...
// ---------- Copies ----------
body.push(article("۱۷", "نسخ قرارداد"));
body.push(p("این قرارداد در ۱۷ ماده و بدون پیوست، در ۲ نسخهٔ متحدالمتن و دارای اعتبار یکسان تنظیم و پس از امضا و مبادله، برای طرفین لازم‌الاجرا است."));
